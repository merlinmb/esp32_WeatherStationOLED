...
OneButton _button1(A1, true);
// Setup a new OneButton on pin A2.  
OneButton _button2(A2, true);
...
void setup() {
  ...
  _button1.attachClick(click1);
  _button1.attachDoubleClick(doubleclick1);
  _button1.attachLongPressStart(longPressStart1);
  _button1.attachLongPressStop(longPressStop1);
  _button1.attachDuringLongPress(longPress1);

  // link the button 2 functions.
  _button2.attachClick(click2);
  _button2.attachDoubleClick(doubleclick2);
  _button2.attachLongPressStart(longPressStart2);
  _button2.attachLongPressStop(longPressStop2);
  _button2.attachDuringLongPress(longPress2);
